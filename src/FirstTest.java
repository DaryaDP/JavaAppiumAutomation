...
public class FirstTest {
    ...
    public void firstTest() {
        ...
        waitForElementPresent(
                ...
                "Cannot find 'Object-oriented programming language' in topic Java",
                15
        );
    }
    ...
    public void testSearchSeveralArticles() {
        ...
        List search_results = waitForSeveralElements(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']"),
                "there is no results of search",
                10
        );
        Assert.assertTrue(search_results.size() > 0);
        waitForElementAndClear(
                By.id("org.wikipedia:id/search_src_text"),
                "Cannot find search field",
                5
    ...
    public void testSearchResultWithWord() {
        ...
        Assert.assertTrue(search_results.size() == counter.get());
    ...
    public void saveFirstArticleToMyList() {
        ...
        waitForElementAndClick(
                ...
                "Cannot find created folder 'Learning programming'",
                5
        );
    ...
    public void testAmountOfEmptySearch() {
        ...
        waitForElementPresent(
                ...
                "Cannot finf empty resilts label by the requst " + search_line,
                15
        );
    ...
    public void saveTwoArticlesToMyListAndDeleteOne() {
        ...
        String title_of_second_article = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                15
        ...
        String title_of_second_article_in_folder = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                15
    ...
    private List<WebElement> waitForSeveralElements(By by, String error_message, long timeoutInSeconds) {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
